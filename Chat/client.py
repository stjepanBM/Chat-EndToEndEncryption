...
if __name__ == "__main__":
    ...
    if check is True:
        ...
        decrypted = decryptor.decrypt(eval(toDecrypt.replace(b"\r\n", b'')))
        splittedDecrypt = decrypted.decode().split(":")
        ...
        if str(server_public_hash) == str(hashOfSPublic) or str(session) == str(hashOfEight):
            ...
            encrypted_serverPublic = encrypt_key(serverpublicKey, eightByte)
